...
#ifdef CONFIG_GENIUS_CONNECT_IPV6
...
#endif // CONFIG_GENIUS_CONNECT_IPV6
...
esp_err_t genius_connect()
{
    ...
    // Now, we should have a clean status !
    ESP_ERROR_CHECK(err);
...
static void start()
{
    ...
    wifi_config_t wifi_config = {
        .sta = {
            .ssid = CONFIG_GENIUS_WIFI_SSID,
            .password = CONFIG_GENIUS_WIFI_PASSWORD,
        },
    };
    ...
    ESP_ERROR_CHECK(esp_wifi_connect());
    s_connection_name = CONFIG_GENIUS_WIFI_SSID;
}
...
#endif // CONFIG_GENIUS_CONNECT_WIFI
...
static void start()
{
    ...
    phy_config.phy_addr = CONFIG_GENIUS_ETH_PHY_ADDR;
    phy_config.reset_gpio_num = CONFIG_GENIUS_ETH_PHY_RST_GPIO;
#if CONFIG_GENIUS_USE_INTERNAL_ETHERNET
    mac_config.smi_mdc_gpio_num = CONFIG_GENIUS_ETH_MDC_GPIO;
    mac_config.smi_mdio_gpio_num = CONFIG_GENIUS_ETH_MDIO_GPIO;
    s_mac = esp_eth_mac_new_esp32(&mac_config);
#if CONFIG_GENIUS_ETH_PHY_IP101
    s_phy = esp_eth_phy_new_ip101(&phy_config);
#elif CONFIG_GENIUS_ETH_PHY_RTL8201
    s_phy = esp_eth_phy_new_rtl8201(&phy_config);
#elif CONFIG_GENIUS_ETH_PHY_LAN8720
    s_phy = esp_eth_phy_new_lan8720(&phy_config);
#elif CONFIG_GENIUS_ETH_PHY_DP83848
    s_phy = esp_eth_phy_new_dp83848(&phy_config);
#endif
#elif CONFIG_GENIUS_USE_DM9051
    gpio_install_isr_service(0);
    spi_device_handle_t spi_handle = NULL;
    spi_bus_config_t buscfg = {
        .miso_io_num = CONFIG_GENIUS_DM9051_MISO_GPIO,
        .mosi_io_num = CONFIG_GENIUS_DM9051_MOSI_GPIO,
        .sclk_io_num = CONFIG_GENIUS_DM9051_SCLK_GPIO,
        .quadwp_io_num = -1,
        .quadhd_io_num = -1,
    };
    ESP_ERROR_CHECK(spi_bus_initialize(CONFIG_GENIUS_DM9051_SPI_HOST, &buscfg, 1));
    spi_device_interface_config_t devcfg = {
        .command_bits = 1,
        .address_bits = 7,
        .mode = 0,
        .clock_speed_hz = CONFIG_GENIUS_DM9051_SPI_CLOCK_MHZ * 1000 * 1000,
        .spics_io_num = CONFIG_GENIUS_DM9051_CS_GPIO,
        .queue_size = 20
    };
    ESP_ERROR_CHECK(spi_bus_add_device(CONFIG_GENIUS_DM9051_SPI_HOST, &devcfg, &spi_handle));
    /* dm9051 ethernet driver is based on spi driver */
    eth_dm9051_config_t dm9051_config = ETH_DM9051_DEFAULT_CONFIG(spi_handle);
    dm9051_config.int_gpio_num = CONFIG_GENIUS_DM9051_INT_GPIO;
...
#endif // CONFIG_GENIUS_CONNECT_ETHERNET
